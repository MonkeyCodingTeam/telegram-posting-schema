...
CREATE TABLE `content_post` (
  ...
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  KEY `content_post_post_id_foreign` (`post_id`),
  KEY `content_post_content_id_foreign` (`content_id`),
  CONSTRAINT `content_post_content_id_foreign` FOREIGN KEY (`content_id`) REFERENCES `contents` (`id`) ON DELETE CASCADE,
  CONSTRAINT `content_post_post_id_foreign` FOREIGN KEY (`post_id`) REFERENCES `posts` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
(13,'2025_04_14_154548_create_content_post_table',1);
...
CREATE TABLE `video_notes` (
  ...
  KEY `video_notes_folder_id_foreign` (`folder_id`),
  KEY `video_notes_parent_id_foreign` (`parent_id`),
  CONSTRAINT `video_notes_chat_id_foreign` FOREIGN KEY (`chat_id`) REFERENCES `chats` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `video_notes_content_id_foreign` FOREIGN KEY (`content_id`) REFERENCES `contents` (`id`),
  CONSTRAINT `video_notes_folder_id_foreign` FOREIGN KEY (`folder_id`) REFERENCES `folders` (`id`) ON DELETE CASCADE,
  CONSTRAINT `video_notes_parent_id_foreign` FOREIGN KEY (`parent_id`) REFERENCES `video_notes` (`id`) ON DELETE SET NULL,
...
-- Dump completed on 2025-04-15 13:05:03
