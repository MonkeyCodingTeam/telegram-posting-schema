...
CREATE TABLE "content_planable" (
  "content_plan_id" bigint(20) NOT NULL,
  "content_planable_type" varchar(255) NOT NULL,
  "content_planable_id" bigint(20) NOT NULL,
  "created_at" timestamp NOT NULL DEFAULT (current_timestamp()),
  PRIMARY KEY ("content_plan_id", "content_planable_id", "content_planable_type")
);
...
CREATE TABLE "posts" (
  ...
  "postable_id" bigint(20) NOT NULL,
  "created_at" timestamp DEFAULT null,
  "updated_at" timestamp DEFAULT null
);
...
CREATE TABLE "stories" (
  ...
  "template_id" bigint(20) DEFAULT null,
  "parent_id" bigint(20) DEFAULT null,
  "storyable_type" varchar(255) NOT NULL,
  "storyable_id" bigint(20) NOT NULL,
  "created_at" timestamp DEFAULT null,
  "updated_at" timestamp DEFAULT null
);
...
CREATE TABLE "video_notes" (
  ...
  "content_id" bigint(20) NOT NULL,
  "parent_id" bigint(20) DEFAULT null,
  "video_noteable_type" varchar(255) NOT NULL,
  "video_noteable_id" bigint(20) NOT NULL,
  "created_at" timestamp DEFAULT null,
  "updated_at" timestamp DEFAULT null
);
...
CREATE INDEX "content_planable_content_planable_type_content_planable_id_index" ON "content_planable" ("content_planable_type", "content_planable_id");
...
CREATE INDEX "posts_postable_type_postable_id_index" ON "posts" ("postable_type", "postable_id");
...
CREATE INDEX "stories_storyable_type_storyable_id_index" ON "stories" ("storyable_type", "storyable_id");
...
CREATE INDEX "video_notes_video_noteable_type_video_noteable_id_index" ON "video_notes" ("video_noteable_type", "video_noteable_id");
...
ALTER TABLE "content_planable" ADD CONSTRAINT "content_planable_content_plan_id_foreign" FOREIGN KEY ("content_plan_id") REFERENCES "content_plans" ("id") ON DELETE CASCADE;
